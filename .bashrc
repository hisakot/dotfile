...
__conda_setup="$('/home/hisakot/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/hisakot/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/hisakot/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/hisakot/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
# sub
xrandr --output HDMI-0 --mode 400x1280 --rotate right --pos 1920x540
